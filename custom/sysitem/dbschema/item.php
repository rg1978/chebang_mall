...
return  array(
    'columns'=> array(
       ...
       // ),
        ...
        'item_type' => array(
			'type' => array(
				0 => app::get('sysitem')->_('实物商品'),
                1 => app::get('sysitem')->_('服务类商品'),
			),
			'default' => '0',
        ...
        'item_service_mode' => array(
			'type' => array(
				0 => app::get('sysitem')->_('实物商品'),
                1 => app::get('sysitem')->_('到店服务'),
                2 => app::get('sysitem')->_('上门服务'),
			),
			'default' => '0',
			'comment' => app::get('sysitem')->_('服务方式'),
			'label' => app::get('sysitem')->_('服务方式'),
		    'in_list' => true,
            'default_in_list' => false,
        ),
    ),
