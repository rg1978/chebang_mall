			...
			if ($.isFunction(self.options.down.callback)) {
				self.pullDownTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="shopex-pull-top-wrapper"><div class="shopex-pull-top-canvas"><canvas id="pullDownTips" width="' + self.options.down.tips.size + '" height="' + self.options.down.tips.size + '"></canvas></div></div>';
