...
//			placeholder //默认图片
		...
		_cacheWidth: function(el) {
			if (el._shopex_lazy_width) {
				return el._shopex_lazy_width;
			}
			return el._shopex_lazy_width = el.offsetWidth;
		},
		_cacheHeight: function(el) {
			if (el._shopex_lazy_height) {
				return el._shopex_lazy_height;
			}
			return el._shopex_lazy_height = el.offsetHeight;
		},
