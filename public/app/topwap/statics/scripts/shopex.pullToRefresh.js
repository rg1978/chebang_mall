			...
			if ($.isFunction(self.options.down.callback)) {
				self.pullDownTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="shopex-pull-top-wrapper"><span class="shopex-pull-loading shopex-icon shopex-icon-pulldown"></span></div>';
			...
			if ($.isFunction(self.options.up.callback)) {
				self.pullUpTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="shopex-pull-bottom-wrapper"><span class="shopex-pull-loading">' + self.options.up.contentdown + '</span></div>';
