var gmu=gmu||{version:"@version",$:window.Zepto,staticCall:function(d){var c=d.fn,e=[].slice,a=d();a.length=1;return function(b,d){a[0]=b;return c[d].apply(a,e.call(arguments,2))}}(Zepto)};
(function(d,c){function e(a,b,c){(a||"").split(h).forEach(function(a){c(a,b)})}function a(a){a=(""+a).split(".");return{e:a[0],ns:a.slice(1).sort().join(" ")}}function b(b,c,d,f){var k,e;e=a(c);e.ns&&(k=RegExp("(?:^| )"+e.ns.replace(" "," .* ?")+"(?: |$)"));return b.filter(function(a){return a&&(!e.e||a.e===e.e)&&(!e.ns||k.test(a.ns))&&(!d||a.cb===d||a.cb._cb===d)&&(!f||a.ctx===f)})}function f(a,b){if(!(this instanceof f))return new f(a,b);b&&c.extend(this,b);this.type=a;return this}var k=[].slice,
h=/\s+/,g=function(){return!1},m=function(){return!0};f.prototype={isDefaultPrevented:g,isPropagationStopped:g,preventDefault:function(){this.isDefaultPrevented=m},stopPropagation:function(){this.isPropagationStopped=m}};d.event={on:function(b,c,d){var f=this,k;if(!c)return this;k=this._events||(this._events=[]);e(b,c,function(b,c){var e=a(b);e.cb=c;e.ctx=d;e.ctx2=d||f;e.id=k.length;k.push(e)});return this},one:function(a,b,c){var d=this;if(!b)return this;e(a,b,function(a,b){var f=function(){d.off(a,
f);return b.apply(c||d,arguments)};f._cb=b;d.on(a,f,c)});return this},off:function(a,c,d){var f=this._events;if(!f)return this;if(!a&&!c&&!d)return this._events=[],this;e(a,c,function(a,c){b(f,a,c,d).forEach(function(a){delete f[a.id]})});return this},trigger:function(a){var c=-1,d,e,h,g,m;if(!this._events||!a)return this;"string"===typeof a&&(a=new f(a));d=k.call(arguments,1);a.args=d;d.unshift(a);if(e=b(this._events,a.type))for(g=e.length;++c<g;)if((h=a.isPropagationStopped())||!1===(m=e[c]).cb.apply(m.ctx2,
d)){h||(a.stopPropagation(),a.preventDefault());break}return this}};d.Event=f})(gmu,gmu.$);
(function(d,c,e){function a(a){return"[object Object]"===r.call(a)}function b(a,b){a&&Object.keys(a).forEach(function(c){b(c,a[c])})}function f(a){for(var b={},c=(a=a&&a.attributes)&&a.length,d,f;c--;)if(f=a[c],d=f.name,"data-"===d.substring(0,5)){d=d.substring(5);f=f.value;try{f="true"===f?!0:"false"===f?!1:"null"===f?null:+f+""===f?+f:/(?:\{[\s\S]*\}|\[[\s\S]*\])$/.test(f)?JSON.parse(f):f}catch(k){f=e}f===e||(b[d]=f)}return b}function k(b){var f=b.substring(0,1).toLowerCase()+b.substring(1),k=c.fn[f];
c.fn[f]=function(f){var k=n.call(arguments,1),h="string"===typeof f&&f,g,l;c.each(this,function(n,m){l=t(m,b)||new d[b](m,a(f)?f:e);if("this"===h)return g=l,!1;if(h){if(!c.isFunction(l[h]))throw Error("组件没有此方法："+h);g=l[h].apply(l,k);if(g!==e&&g!==l)return!1;g=e}});return g!==e?g:this};c.fn[f].noConflict=function(){c.fn[f]=k;return this}}function h(a,f){var d=this;a.superClass&&h.call(d,a.superClass,f);b(t(a,"options"),function(a,b){b.forEach(function(b){var k=b[0];b=b[1];("*"===k||c.isFunction(k)&&
...
1<this.length)&&this.slideTo(this.index+1);return this},getIndex:function(){return this.index},destroy:function(){this._container.off(this.eventNs);c(window).off("ortchange"+this.eventNs);return this.$super("destroy")}})})(gmu,gmu.$);
...
a.$content.on("touchstart"+b,function(a){a.preventDefault()});a.$content.on("tap"+b,function(b){var c=a.getEl(),f=d(b.target);f.hasClass("ui-suggestion-plus")?c.val(f.attr("data-item")):d.contains(a.$content.get(0),f.get(0))&&setTimeout(function(){c.val(f.text());a.trigger("select",f).hide().$form.submit()},400)}).highlight("ui-suggestion-highlight");a.on("destroy",function(){c.size()&&c.off(b);a.$content.off()})});c.on("renderlist",function(a,b,f,k){a=f;f=c._options;var h=[],g="",m,l,p;if(b&&b.length)for(b=
...
c){var l=h["$"+c+"Elem"];l.length&&(a?l.show():d?l.hide():e._setStyle(c,"disable"),e._status(c,a))});return e},disable:function(a,b){return this._setable(!1,a,b)},enable:function(a){return this._setable(!0,a)}})})(gmu,gmu.$);
(function(d,c){function e(a){if(""===k)return a;a=a.charAt(0).toUpperCase()+a.substr(1);return k+a}var a=Math,b=[],f=c.createElement("div").style,k=function(){for(var a=["webkitT","MozT","msT","OT","t"],b,c=0,d=a.length;c<d;c++)if(b=a[c]+"ransform",b in f)return a[c].substr(0,a[c].length-1);return!1}(),h=k?"-"+k.toLowerCase()+"-":"",g=e("transform"),m=e("transitionProperty"),l=e("transitionDuration"),p=e("transformOrigin"),n=e("transitionTimingFunction");e("transitionDelay");var r=/android/gi.test(navigator.appVersion),
q=/hp-tablet/gi.test(navigator.appVersion),s=e("perspective")in f,t="ontouchstart"in d&&!q,v=!!k,w=e("transition")in f,u="onorientationchange"in d?"orientationchange":"resize",y=t?"touchstart":"mousedown",x=t?"touchmove":"mousemove",A=t?"touchend":"mouseup",B=t?"touchcancel":"mouseup",z=!1===k?!1:{"":"transitionend",webkit:"webkitTransitionEnd",Moz:"transitionend",O:"otransitionend",ms:"MSTransitionEnd"}[k],E=function(){return d.requestAnimationFrame||d.webkitRequestAnimationFrame||d.mozRequestAnimationFrame||
d.oRequestAnimationFrame||d.msRequestAnimationFrame||function(a){return setTimeout(a,1)}}(),D=d.cancelRequestAnimationFrame||d.webkitCancelAnimationFrame||d.webkitCancelRequestAnimationFrame||d.mozCancelRequestAnimationFrame||d.oCancelRequestAnimationFrame||d.msCancelRequestAnimationFrame||clearTimeout,C=s?" translateZ(0)":"",q=function(a,b){var e=this,f;e.wrapper="object"==typeof a?a:c.getElementById(a);e.wrapper.style.overflow="hidden";e.scroller=e.wrapper.children[0];e.translateZ=C;e.options={hScroll:!0,
vScroll:!0,x:0,y:0,bounce:!0,bounceLock:!1,momentum:!0,lockDirection:!0,useTransform:!0,useTransition:!1,topOffset:0,checkDOMChanges:!1,handleClick:!0,onRefresh:null,onBeforeScrollStart:function(a){a.preventDefault()},onScrollStart:null,onBeforeScrollMove:null,onScrollMove:null,onBeforeScrollEnd:null,onScrollEnd:null,onTouchEnd:null,onDestroy:null};for(f in b)e.options[f]=b[f];e.x=e.options.x;e.y=e.options.y;e.options.useTransform=v&&e.options.useTransform;e.options.useTransition=w&&e.options.useTransition;
e.scroller.style[m]=e.options.useTransform?h+"transform":"top left";e.scroller.style[l]="0";e.scroller.style[p]="0 0";e.options.useTransition&&(e.scroller.style[n]="cubic-bezier(0.33,0.66,0.66,1)");e.options.useTransform?e.scroller.style[g]="translate("+e.x+"px,"+e.y+"px)"+C:e.scroller.style.cssText+=";position:absolute;top:"+e.y+"px;left:"+e.x+"px";e.refresh();e._bind(u,d);e._bind(y);e.options.checkDOMChanges&&(e.checkDOMTime=setInterval(function(){e._checkDOMChanges()},500))};q.prototype={enabled:!0,
x:0,y:0,steps:[],scale:1,currPageX:0,currPageY:0,pagesX:[],pagesY:[],aniTime:null,isStopScrollAction:!1,handleEvent:function(a){switch(a.type){case y:if(!t&&0!==a.button)break;this._start(a);break;case x:this._move(a);break;case A:case B:this._end(a);break;case u:this._resize();break;case z:this._transitionEnd(a)}},_checkDOMChanges:function(){this.moved||this.animating||this.scrollerW==this.scroller.offsetWidth*this.scale&&this.scrollerH==this.scroller.offsetHeight*this.scale||this.refresh()},_resize:function(){var a=
this;setTimeout(function(){a.refresh()},r?200:0)},_pos:function(b,c){b=this.hScroll?b:0;c=this.vScroll?c:0;this.options.useTransform?this.scroller.style[g]="translate("+b+"px,"+c+"px) scale("+this.scale+")"+C:(b=a.round(b),c=a.round(c),this.scroller.style.left=b+"px",this.scroller.style.top=c+"px");this.x=b;this.y=c},_start:function(b){var c=t?b.touches[0]:b,e,f;this.enabled&&(this.options.onBeforeScrollStart&&this.options.onBeforeScrollStart.call(this,b),this.options.useTransition&&this._transitionTime(0),
this.animating=this.moved=!1,this.dirY=this.dirX=this.absDistY=this.absDistX=this.distY=this.distX=0,this.isStopScrollAction=!1,this.options.momentum&&(this.options.useTransform?(e=getComputedStyle(this.scroller,null)[g].replace(/[^0-9\-.,]/g,"").split(","),f=+e[4],e=+e[5]):(f=+getComputedStyle(this.scroller,null).left.replace(/[^0-9-]/g,""),e=+getComputedStyle(this.scroller,null).top.replace(/[^0-9-]/g,"")),a.round(f)!=a.round(this.x)||a.round(e)!=a.round(this.y))&&(this.isStopScrollAction=!0,this.options.useTransition?
this._unbind(z):D(this.aniTime),this.steps=[],this._pos(f,e),this.options.onScrollEnd&&this.options.onScrollEnd.call(this)),this.startX=this.x,this.startY=this.y,this.pointX=c.pageX,this.pointY=c.pageY,this.startTime=b.timeStamp||Date.now(),this.options.onScrollStart&&this.options.onScrollStart.call(this,b),this._bind(x,d),this._bind(A,d),this._bind(B,d))},_move:function(b){var c=t?b.touches[0]:b,d=c.pageX-this.pointX,e=c.pageY-this.pointY,f=this.x+d,g=this.y+e,l=b.timeStamp||Date.now();this.options.onBeforeScrollMove&&
this.options.onBeforeScrollMove.call(this,b);this.pointX=c.pageX;this.pointY=c.pageY;if(0<f||f<this.maxScrollX)f=this.options.bounce?this.x+d/2:0<=f||0<=this.maxScrollX?0:this.maxScrollX;if(g>this.minScrollY||g<this.maxScrollY)g=this.options.bounce?this.y+e/2:g>=this.minScrollY||0<=this.maxScrollY?this.minScrollY:this.maxScrollY;this.distX+=d;this.distY+=e;this.absDistX=a.abs(this.distX);this.absDistY=a.abs(this.distY);6>this.absDistX&&6>this.absDistY||(this.options.lockDirection&&(this.absDistX>
this.absDistY+5?(g=this.y,e=0):this.absDistY>this.absDistX+5&&(f=this.x,d=0)),this.moved=!0,this._beforePos?this._beforePos(g,e)&&this._pos(f,g):this._pos(f,g),this.dirX=0<d?-1:0>d?1:0,this.dirY=0<e?-1:0>e?1:0,300<l-this.startTime&&(this.startTime=l,this.startX=this.x,this.startY=this.y),this.options.onScrollMove&&this.options.onScrollMove.call(this,b))},_end:function(b){if(!t||0===b.touches.length){var e=this,f=t?b.changedTouches[0]:b,g,l,h={dist:0,time:0},k={dist:0,time:0},m=(b.timeStamp||Date.now())-
e.startTime,n=e.x,p=e.y;e._unbind(x,d);e._unbind(A,d);e._unbind(B,d);e.options.onBeforeScrollEnd&&e.options.onBeforeScrollEnd.call(e,b);if(e.moved){if(300>m&&e.options.momentum){h=n?e._momentum(n-e.startX,m,-e.x,e.scrollerW-e.wrapperW+e.x,e.options.bounce?e.wrapperW:0):h;k=p?e._momentum(p-e.startY,m,-e.y,0>e.maxScrollY?e.scrollerH-e.wrapperH+e.y-e.minScrollY:0,e.options.bounce?e.wrapperH:0):k;n=e.x+h.dist;p=e.y+k.dist;if(0<e.x&&0<n||e.x<e.maxScrollX&&n<e.maxScrollX)h={dist:0,time:0};if(e.y>e.minScrollY&&
p>e.minScrollY||e.y<e.maxScrollY&&p<e.maxScrollY)k={dist:0,time:0}}h.dist||k.dist?(h=a.max(a.max(h.time,k.time),10),e.scrollTo(a.round(n),a.round(p),h)):e._resetPos(200)}else t&&this.options.handleClick&&!e.isStopScrollAction&&(e.doubleTapTimer=setTimeout(function(){e.doubleTapTimer=null;for(g=f.target;1!=g.nodeType;)g=g.parentNode;"SELECT"!=g.tagName&&"INPUT"!=g.tagName&&"TEXTAREA"!=g.tagName&&(l=c.createEvent("MouseEvents"),l.initMouseEvent("click",!0,!0,b.view,1,f.screenX,f.screenY,f.clientX,f.clientY,
b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,0,null),l._fake=!0,g.dispatchEvent(l))},0)),e._resetPos(400);e.options.onTouchEnd&&e.options.onTouchEnd.call(e,b)}},_resetPos:function(a){var b=0<=this.x?0:this.x<this.maxScrollX?this.maxScrollX:this.x,c=this.y>=this.minScrollY||0<this.maxScrollY?this.minScrollY:this.y<this.maxScrollY?this.maxScrollY:this.y;b==this.x&&c==this.y?this.moved&&(this.moved=!1,this.options.onScrollEnd&&this.options.onScrollEnd.call(this),this._afterPos&&this._afterPos()):this.scrollTo(b,
c,a||0)},_transitionEnd:function(a){a.target==this.scroller&&(this._unbind(z),this._startAni())},_startAni:function(){var b=this,c=b.x,d=b.y,e=Date.now(),f,g,l;b.animating||(b.steps.length?(f=b.steps.shift(),f.x==c&&f.y==d&&(f.time=0),b.animating=!0,b.moved=!0,b.options.useTransition?(b._transitionTime(f.time),b._pos(f.x,f.y),b.animating=!1,f.time?b._bind(z):b._resetPos(0)):(l=function(){var h=Date.now(),k;h>=e+f.time?(b._pos(f.x,f.y),b.animating=!1,b.options.onAnimationEnd&&b.options.onAnimationEnd.call(b),
b._startAni()):(h=(h-e)/f.time-1,g=a.sqrt(1-h*h),h=(f.x-c)*g+c,k=(f.y-d)*g+d,b._pos(h,k),b.animating&&(b.aniTime=E(l)))},l())):b._resetPos(400))},_transitionTime:function(a){this.scroller.style[l]=a+"ms"},_momentum:function(b,c,d,e,f){c=a.abs(b)*(this.options.speedScale||1)/c;var g=c*c/0.0012;0<b&&g>d?(d+=f/(6/(g/c*6E-4)),c=c*d/g,g=d):0>b&&g>e&&(e+=f/(6/(g/c*6E-4)),c=c*e/g,g=e);return{dist:g*(0>b?-1:1),time:a.round(c/6E-4)}},_offset:function(a){for(var b=-a.offsetLeft,c=-a.offsetTop;a=a.offsetParent;)b-=
a.offsetLeft,c-=a.offsetTop;a!=this.wrapper&&(b*=this.scale,c*=this.scale);return{left:b,top:c}},_bind:function(a,c,d){b.concat([c||this.scroller,a,this]);(c||this.scroller).addEventListener(a,this,!!d)},_unbind:function(a,b,c){(b||this.scroller).removeEventListener(a,this,!!c)},destroy:function(){this.scroller.style[g]="";this._unbind(u,d);this._unbind(y);this._unbind(x,d);this._unbind(A,d);this._unbind(B,d);this.options.useTransition&&this._unbind(z);this.options.checkDOMChanges&&clearInterval(this.checkDOMTime);
this.options.onDestroy&&this.options.onDestroy.call(this);for(var a=0,c=b.length;a<c;)b[a].removeEventListener(b[a+1],b[a+2]),b[a]=null,a+=3;b=[]},refresh:function(){var b;this.wrapperW=this.wrapper.clientWidth||1;this.wrapperH=this.wrapper.clientHeight||1;this.minScrollY=-this.options.topOffset||0;this.scrollerW=a.round(this.scroller.offsetWidth*this.scale);this.scrollerH=a.round((this.scroller.offsetHeight+this.minScrollY)*this.scale);this.maxScrollX=this.wrapperW-this.scrollerW;this.maxScrollY=
this.wrapperH-this.scrollerH+this.minScrollY;this.dirY=this.dirX=0;this.options.onRefresh&&this.options.onRefresh.call(this);this.hScroll=this.options.hScroll&&0>this.maxScrollX;this.vScroll=this.options.vScroll&&(!this.options.bounceLock&&!this.hScroll||this.scrollerH>this.wrapperH);b=this._offset(this.wrapper);this.wrapperOffsetLeft=-b.left;this.wrapperOffsetTop=-b.top;this.scroller.style[l]="0";this._resetPos(400)},scrollTo:function(a,b,c,d){var e=a;this.stop();e.length||(e=[{x:a,y:b,time:c,relative:d}]);
a=0;for(b=e.length;a<b;a++)e[a].relative&&(e[a].x=this.x-e[a].x,e[a].y=this.y-e[a].y),this.steps.push({x:e[a].x,y:e[a].y,time:e[a].time||0});this._startAni()},scrollToElement:function(b,c){var d;if(b=b.nodeType?b:this.scroller.querySelector(b))d=this._offset(b),d.left+=this.wrapperOffsetLeft,d.top+=this.wrapperOffsetTop,d.left=0<d.left?0:d.left<this.maxScrollX?this.maxScrollX:d.left,d.top=d.top>this.minScrollY?this.minScrollY:d.top<this.maxScrollY?this.maxScrollY:d.top,c=void 0===c?a.max(2*a.abs(d.left),
2*a.abs(d.top)):c,this.scrollTo(d.left,d.top,c)},scrollToPage:function(a,b,c){c=void 0===c?400:c;this.options.onScrollStart&&this.options.onScrollStart.call(this);a*=-this.wrapperW;b*=-this.wrapperH;a<this.maxScrollX&&(a=this.maxScrollX);b<this.maxScrollY&&(b=this.maxScrollY);this.scrollTo(a,b,c)},disable:function(){this.stop();this._resetPos(0);this.enabled=!1;this._unbind(x,d);this._unbind(A,d);this._unbind(B,d)},enable:function(){this.enabled=!0},stop:function(){this.options.useTransition?this._unbind(z):
D(this.aniTime);this.steps=[];this.animating=this.moved=!1},isReady:function(){return!this.moved&&!this.animating}};f=null;"undefined"!==typeof exports?exports.iScroll=q:d.iScroll=q;(function(a,b,c){if(a){var d=b.iScroll,e=[].slice,f=function(){var a={},b=0;return function(d,e){var f=d._sid||(d._sid=++b);e!==c&&(a[f]=e);null===e&&delete a[f];return a[f]}}(),g;b.iScroll=g=function(a,b){[].slice.call(arguments,0);var c=new d(a,b);f(a,c);return c};g.prototype=d.prototype;a.fn.iScroll=function(b){var d=
e.call(arguments,1),l="string"===typeof b&&b,h,k;a.each(this,function(e,m){k=f(m)||g(m,a.isPlainObject(b)?b:c);if("this"===l)return h=k,!1;if(l){if(!a.isFunction(k[l]))throw Error("iScroll没有此方法："+l);h=k[l].apply(k,d);if(h!==c&&h!==k)return!1;h=c}});return h!==c?h:this}}})(d.Zepto||null,d)})(window,document);
(function(d,c,e){d.define("Navigator",{options:{content:null,event:"click"},template:{list:"<ul>",item:'<li><a<% if( href ) { %> href="<%= href %>"<% } %>><%= text %></a></li>'},_create:function(){var a=this,b=a._options,d=a.getEl(),k=d.find("ul").first(),h="ui-"+a.widgetName,g,m;!k.length&&b.content?(k=c(a.tpl2html("list")),g=a.tpl2html("item"),m="",b.content.forEach(function(a){a=c.extend({href:"",text:""},"string"===typeof a?{text:a}:a);m+=g(a)}),k.append(m).appendTo(d)):(d.is("ul, ol")&&(k=d.wrap("<div>"),
d=d.parent()),b.index===e&&(b.index=k.find(".ui-state-active").index()));a.$list=k.addClass(h+"-list");a.trigger("done.dom",d.addClass(h),b);k.highlight("ui-state-hover","li");k.on(b.event+a.eventNs,"li:not(.ui-state-disable)>a",function(b){a._switchTo(c(this).parent().index(),b)});a.index=-1;a.switchTo(b.index)},_switchTo:function(a,b){if(a!==this.index){var c=this.$list.children(),e=d.Event("beforeselect",b);this.trigger(e,c.get(a));if(!e.isDefaultPrevented())return c=c.removeClass("ui-state-active").eq(a).addClass("ui-state-active"),
this.index=a,this.trigger("select",a,c[0])}},switchTo:function(a){return this._switchTo(~~a)},unselect:function(){this.index=-1;this.$list.children().removeClass("ui-state-active")},getIndex:function(){return this.index}})})(gmu,gmu.$);
(function(d,c,e){d.Navigator.options.iScroll={hScroll:!0,vScroll:!1,hScrollbar:!1,vScrollbar:!1};d.Navigator.register("scrollable",{_init:function(){var a=this,b=a._options;a.on("done.dom",function(){a.$list.wrap('<div class="ui-scroller"></div>');a.trigger("init.iScroll");a.$el.iScroll(c.extend({},b.iScroll))});c(window).on("ortchange"+a.eventNs,c.proxy(a.refresh,a));a.on("destroy",function(){a.$el.iScroll("destroy");c(window).off("ortchange"+a.eventNs)})},refresh:function(){this.trigger("refresh.iScroll").$el.iScroll("refresh")}})})(gmu,
gmu.$);(function(d,c,e){d.Navigator.options.isScrollToNext=!0;d.Navigator.option("isScrollToNext",!0,function(){var a=this,b;a.on("select",function(d,k,h){b===e&&(b=a.index?0:1);d=k>b;h=c(h)[d?"next":"prev"]().offset()||c(h).offset();var g=a.$el.offset(),m;if(d?h.left+h.width>g.left+g.width:h.left<g.left)m=a.$list.offset(),a.$el.iScroll("scrollTo",d?g.width-h.left+m.left-h.width:m.left-h.left,0,400);b=k})})})(gmu,gmu.$);(function(d,c,e){d.define("Message",{options:{container:"#message",prefix:"message",target:document.body,type:"error",hideDelay:3},_create:function(){var a=this.getEl();a&&a.length||(this.$el=c('<div id="message" class="message message-'+this._options.type+' fade"></div>'));this.$el.appendTo(this._options.target||document.body);return this},getEl:function(){return this.$el=c(this._options.container)},show:function(a,b,d){if(a)return c.isPlainObject(b)&&(d=b,b=null),c.extend(!0,this._options,d||{}),
