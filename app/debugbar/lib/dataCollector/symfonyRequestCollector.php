 ...
 *
 */
class debugbar_dataCollector_symfonyRequestCollector extends DataCollector implements DataCollectorInterface, Renderable
{
    ...
    public function collect()
    {
        ...
        */
        $sessionAttributes = array();
        foreach ((array)$this->session as $key => $value) {
            $sessionAttributes[$key] = $value;
        }
        $data['session_attributes'] = $sessionAttributes;
