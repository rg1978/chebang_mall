...
class system_ctl_admin_messenger extends desktop_controller{
    ...
    public function index()
    {
        ...
        if($this->has_permission('system_messenger_set_email')){
            $pagedata['email_set'] = "is_show";
        }
    ...
    public function saveTmpl()
    {
        ...
        $content=$this->__checkReg($postdata['content']);
    ...
    private function __checkReg($content)
    {
        $arr = array(
            '【', '】',
        );
